 ...
 */
package com.readora.facades.service.impl;
...
public class DefaultReadorafacadesService implements ReadorafacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultReadorafacadesService.class);
	...
	{
		return DefaultReadorafacadesService.class.getResourceAsStream("/readorafacades/sap-hybris-platform.png");
	}
