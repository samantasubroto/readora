 ...
 */
package com.readora.core.service.impl;
...
public class DefaultReadoracoreService implements ReadoracoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultReadoracoreService.class);
	...
	{
		return DefaultReadoracoreService.class.getResourceAsStream("/readoracore/sap-hybris-platform.png");
	}
