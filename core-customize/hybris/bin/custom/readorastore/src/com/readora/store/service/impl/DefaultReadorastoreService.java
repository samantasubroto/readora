...
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultReadorastoreService.class);
	...
	{
		return DefaultReadorastoreService.class.getResourceAsStream("/readorastore/sap-hybris-platform.png");
	}
